...
public class KicRdsStack extends Stack {
    public KicRdsStack(final Construct scope, final String id, final Vpc vpc) {
        this(scope, id, null, vpc);
    }

    public KicRdsStack(final Construct scope, final String id, final StackProps props, final Vpc vpc) {
        ...
        DatabaseInstance database = DatabaseInstance.Builder
                ...
                .instanceIdentifier("kic-aws-pedido-db")
